...
// const URL = "/transaction-detail/inqueue";

function InQueueList() {
    ...
    const data = dataa.filter(trans => trans.courier_stage === "IN QUEUE" && trans.branch_id === branch_id)
...
const handleEdit = (id) => {
    if(selectPagee !== MODALNAMES.INQUEUEMODAL){
        ...
        dispatch(setActionPage({isEdit:true, page:MODALNAMES.INQUEUEMODAL, id}))
          ...
          const handleEdit = (e) => {
            ...
            const currentRow = params.row;
                        ...
                        if(selectPagee !== MODALNAMES.INQUEUEMODAL){
                            ...
                            dispatch(setActionPage({isEdit:true, page:MODALNAMES.INQUEUEMODAL, id:currentRow.id}))
                            //console.log(selectPagee)
